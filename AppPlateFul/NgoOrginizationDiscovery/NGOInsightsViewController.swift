...
// Displays NGO insights (ratings and operational info) and allows leaving a review
class NGOInsightsViewController: UIViewController {
    ...
    private func configureNavigationBar() {
        ...
        appearance.backgroundColor =
            UIColor(red: 0.969, green: 0.957, blue: 0.949, alpha: 1.0)
    ...
    // MARK: - UI
    // Populates the UI with NGO and insights data
    ...
    // Extracts an area name from a comma-separated address

...
enum DonationStatus: String, CaseIterable {
    ...
    var color: UIColor {
        ...
        case .ongoing: return DonationTheme.statusOngoing
        case .completed, .pickedUp: return DonationTheme.statusCompleted
        case .cancelled: return DonationTheme.statusCancelled
        }
    }
}
